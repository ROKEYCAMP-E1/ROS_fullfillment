...
bool ff_interface__msg__aruco_detections__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ff_interface.msg._aruco_detections.ArucoDetections", full_classname_dest, 50) == 0);
  }
  ff_interface__msg__ArucoDetections * ros_message = _ros_message;
  {  // marker_ids
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int32_t * dest = ros_message->marker_ids.data;
...
{
  /* NOTE(esteve): Call constructor of ArucoDetections */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ff_interface.msg._aruco_detections");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ArucoDetections");
  ...
  {  // marker_ids
    ...
    if (ros_message->marker_ids.size > 0) {
      ...
      int32_t * src = &(ros_message->marker_ids.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->marker_ids.size * sizeof(int32_t));
      assert(data != NULL);
