...
class WorkspaceWindow(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        loadUi("/home/rokey/4W/fullfillment_ws/src/conveyor/conveyor/ui/workspace.ui", self)
...
class ControlWindow(QMainWindow):
    ...
    stop_con_signal = pyqtSignal(int)
    ...
    def __init__(self,parent=None):
        if not self._initialized:
            ...
            loadUi("/home/rokey/4W/fullfillment_ws/src/conveyor/conveyor/ui/control_window.ui", self)
