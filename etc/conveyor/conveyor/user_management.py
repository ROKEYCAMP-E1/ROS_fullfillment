...
class LoginWindow(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        loadUi("/home/rokey/4W/fullfillment_ws/src/conveyor/conveyor/ui/login_window.ui", self)
...
class MyPageWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        loadUi("/home/rokey/4W/fullfillment_ws/src/conveyor/conveyor/ui/mypage_window.ui", self)
